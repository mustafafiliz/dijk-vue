...
<template>
  <div
    class="relative flex flex-col h-dvh w-dvw max-h-dvh bg-gradient-to-b from-cornflower via-lucid-dreams via-25% to-lynx-white px-4 pt-[4.8125rem] pb-24"
  >
    ...
    <div class="flex flex-col mt-8">
      ...
      <div class="font-medium text-18 text-squant mt-2 mb-6">Human resources, Simplified !</div>
    ...
    <!-- input modal start -->
    <div
      class="absolute top-0 left-0 w-full h-full bg-black bg-opacity-30 backdrop-blur-2xl transition-transform"
      :class="{ 'transform -translate-x-0': isModalOpen, '-translate-x-full': !isModalOpen }"
    >
      <Button
      ...
      <div class="flex flex-col items-center justify-center h-full p-4">
        ...
        <div class="flex flex-col items-start w-full">
          ...
          <div class="flex items-center w-full mt-1 mb-4">
