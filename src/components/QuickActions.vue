...
onMounted(() => {
  ...
  swiper.params.navigation.nextEl = '.custom-button-next'
  swiper.params.navigation.prevEl = '.custom-button-prev'
...
<template>
  <div class="flex items-center gap-x-[10px]">
    <div class="custom-button-prev cursor-pointer max-md:hidden">
      <svg
        width="36"
        height="36"
        viewBox="0 0 36 36"
