<template>
  ...
  <div class="md:hidden flex md:top-5 sticky left-0 bottom-0 w-full z-10 h-fit mt-5">
    <div class="pl-3 w-[calc((100vw-100px)/2)] flex bg-white shadow-t h-full">
      ...
      <RouterLink
        class="h-[64px] -mr-7 z-[11] flex flex-col items-center justify-center flex-1 gap-1 md:flex-row"
        to="/dashboard/fields"
      >
        <span class="w-7 h-7 flex items-center justify-center">
          <svg
    ...
    <div class="relative w-[100px] h-full">
      <div class="absolute left-1/2 -translate-x-1/2 bottom-[45px] z-[11]">
        <button
          class="flex rounded-full bg-gentian-flower w-12 h-12 items-center justify-center shadow-2xl"
      ...
      <div class="curve absolute z-10 bottom-0 h-full"></div>
      <div class="absolute bottom-0 bg-white w-full h-10"></div>
    </div>
    <div class="pr-3 w-[calc((100vw-100px)/2)] shadow-t flex bg-white h-full">
      <RouterLink
        class="-ml-7 z-[11] flex flex-col h-[64px] items-center justify-center flex-1 gap-1 md:flex-row"
      ...
      >
        ...
        <span
          class="text-[10px] font-semibold"
          :class="
            $route.fullPath == '/dashboard/calendar' ? 'text-gentian-flower' : 'text-night-sky'
          "
        >
          Takvim
        </span>
      ...
      <RouterLink
        class="flex flex-col h-[64px] items-center justify-center flex-1 gap-1 md:flex-row"
      ...
      >
        ...
        <span
          class="text-[10px] font-semibold"
          :class="
            $route.fullPath.includes('/dashboard/profile/')
              ? 'text-gentian-flower'
              : 'text-night-sky'
          "
        >
